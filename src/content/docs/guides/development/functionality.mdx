...
## First fragment
The first part will be to get the document where we will change the functionality. Lets navigate to the folder `app/java/com.example.newproject/FirstFragment`.
