...
On this second part you will be learning how to style the different components we created on the last secition. 
...
Afterwards, get back to the code view of `fragment_first` and add to the chronometer the following line:
...
First, switch back to the design window. Then, select the screen and adjust the attribute _background_ to the desired color
![background_color](../../../../assets/images/background_color.png)

If you click on any component (buttons or chronometer), a menu will pop up where you can change attributes the component.

![attributes_style](../../../../assets/images/attributes_style.png)

Great, now you know how to style you application and how to add personality to it. To continue the tutorial, navigate to the [functionality section](../../development/functionality). You will learn how to make your app interactive trough the components in the screen
