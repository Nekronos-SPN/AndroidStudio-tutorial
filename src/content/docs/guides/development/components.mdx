...
Now, lets change the name of the button and the text displayed on it. For it to apply, you must change the attribute id for the name and the attribute text to change the text of the button.
...
Also, on the attributes section, there is a constraint menu where you can select a constraint and delete it manually.
