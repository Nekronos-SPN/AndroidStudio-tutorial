...
To begin, let's replace the existing TextView code with a Chronometer component. Here's the updated XML code:
...
Let's enhance the app's layout by adjusting the display of components and introducing new buttons. Begin by switching back to the Design view, where you can see both the button and the chronometer on the screen. Once you are there click on the white phone screen.

![Attributes Display](../../../../assets/images/attributes_display.png)

In the Common Attributes section, locate and set the **fillViewport** attribute to true.
...
# TODO Esto es ilegible, Mejor borrarlo la verdad. Las imagenes apenas se pueden leer.
